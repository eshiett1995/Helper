...
function viewDevicesPageModel() {
    ...
    model.initDataTable = function () {
        ...
        $('#DataTables_Table_0').DataTable({
            ...
            "ajax": {
                "url": "/api/back-office/device/view/query",
                "data": function ( data ) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#deleteBtn', function (){
            ...
            $.confirm({
                ...
                buttons: {
                    Yes: function () {
                        deleteData("/api/back-office/device/delete/" + data._id,function (isSuccessful, response) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#updateBtn', function (){
            ...
            window.location.href = "#/update/device/" + data._id;
