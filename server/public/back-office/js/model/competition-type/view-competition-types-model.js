...
function viewCompetitionTypesPageModel() {
    ...
    model.initDataTable = function () {
        ...
        $('#DataTables_Table_0').DataTable({
            ...
            "ajax": {
                "url": "/api/back-office/competition-type/view/query",
                "data": function ( data ) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#deleteBtn', function (){
            ...
            $.confirm({
                title: 'Delete Competition Type!',
                content: 'Are you sure you want to delete this competition type?',
                buttons: {
                    Yes: function () {
                        deleteData("/api/back-office/competition-type/delete/" + data._id,function (isSuccessful, response) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#updateBtn', function (){
            ...
            window.location.href = "#/update/competition-type/" + data._id;
