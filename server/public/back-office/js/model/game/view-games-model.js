...
function viewGamesPageModel() {
    ...
    model.initDataTable = function () {
        ...
        $('#DataTables_Table_0').DataTable({
            ...
            "ajax": {
                "url": "/api/back-office/game/view/query",
                "data": function ( data ) {
            ...
            $.confirm({
                ...
                buttons: {
                    Yes: function () {
                        ...
                        deleteData("/api/back-office/game/delete/" + data._id,function (isSuccessful, response) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#updateBtn', function (){
            ...
            window.location.href = "#/update/" + data._id;
