...
function viewPlatformsPageModel() {
    ...
    model.initDataTable = function () {
        ...
        $('#DataTables_Table_0').DataTable({
            ...
            "ajax": {
                "url": "/api/back-office/platform/view/query",
                "data": function ( data ) {
            ...
            "columns": [
                ...
                { "data": "device.name", "name" : "Device" , "title" : "Device"},
                { "data": "operatingSystem.name", "name" : "OS" , "title" : "OS"},
                { "class":"",
                    "orderable": false,
                    "data": "detail",
        ...
        $('#DataTables_Table_0 tbody').on('click', '#deleteBtn', function (){
            ...
            $.confirm({
                ...
                buttons: {
                    Yes: function () {
                        deleteData("/api/back-office/platform/delete/" + data._id,function (isSuccessful, response) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#updateBtn', function (){
            ...
            window.location.href = "#/update/platform/" + data._id;
