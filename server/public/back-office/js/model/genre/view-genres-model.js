...
function viewGenresPageModel() {
    ...
    model.initDataTable = function () {
        ...
        $('#DataTables_Table_0').DataTable({
            ...
            "ajax": {
                "url": "/api/back-office/genre/view/query",
                "data": function ( data ) {
            ...
            $.confirm({
                ...
                buttons: {
                    Yes: function () {
                        ...
                        deleteData("/api/back-office/genre/delete/" + data._id,function (isSuccessful, response) {
        ...
        $('#DataTables_Table_0 tbody').on('click', '#updateBtn', function (){
            ...
            window.location.href = "#/update/genre/" + data._id;
